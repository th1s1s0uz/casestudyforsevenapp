...
import { Text, View, ActivityIndicator, ScrollView, TouchableOpacity, RefreshControl } from 'react-native';

import { Button } from '@/components/Button';
import { Container } from '@/components/Container';
import { AppRoutes, ScreenTitles } from '@/constants/navigation';
    ...
    <Container>
      ...
      <View className="flex-1 bg-primary-50">
        ...
        >
          ...
          <View className="mb-6">
            <Link href={AppRoutes.TASKS} asChild>
            ...
            <View className="mb-6">
              ...
              {tasks.slice(0, 3).map((task) => {
                ...
                return (
                  <View
                    key={task.id}
                    className="p-4 mb-2 rounded-2xl border border-gray-500 bg-glass-card"
                  >
                    <View className="flex-row items-center">
                      <View className="w-10 h-10 items-center justify-center mr-3 bg-gray-100 rounded-xl">
                      ...
                      <View className={`w-6 h-6 rounded-full items-center justify-center ${task.is_completed ? 'bg-accent-green-500' : 'bg-gray-200'}`}>
                        {task.is_completed && (
